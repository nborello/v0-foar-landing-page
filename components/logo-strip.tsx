...
export default function LogoStrip() {
  ...
  // Cada logo tiene su propia imagen
  const logos = [
    { name: "Google", src: "/logos/google.png", width: 160 },
    { name: "Meta", src: "/logos/meta.png", width: 160 },
    { name: "OpenAI", src: "/logos/openai.png", width: 160 },
    { name: "Amazon", src: "/logos/amazon.png", width: 160 },
    { name: "Salesforce", src: "/logos/salesforce.png", width: 160 },
  ]
        ...
        <div className="relative w-full overflow-hidden animate-on-scroll opacity-0 animate-delay-100">
          ...
          <div className="flex items-center gap-28 animate-scroll whitespace-nowrap">
            {[...logos, ...logos].map((logo, index) => (
              ...
              >
                <img
                  src="/images/design-mode/LOGO%20Principal%20Negro(1).png"
                  alt={`${logo.name} logo`}
                  className="h-14 md:h-16 w-auto grayscale hover:grayscale-0 transition-transform duration-300 ease-out will-change-transform hover:scale-105"
                />
              </div>
            ))}
          </div>
